...
{
	try {
        // Calls the auction. Will revert if the 30-second interval has not passed.
        await contractInstance.methods.doubleAuction().send({from: myAccount, gasLimit: '0xe00000'});
